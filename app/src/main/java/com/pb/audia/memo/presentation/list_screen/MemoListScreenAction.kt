...
sealed interface MemoListScreenAction {
    ...
    data class OnFilterByMoodClick(val moodUi: com.pb.audia.memo.presentation.models.MoodUi) : MemoListScreenAction
    ...
    data class OnRemoveFilters(val filterType: com.pb.audia.memo.presentation.list_screen.MemoFilterType) : MemoListScreenAction
    ...
    data class OnTrackSizeAvailable(val trackSize: com.pb.audia.memo.presentation.models.TrackSizeInfo) : MemoListScreenAction
}