...
fun MemoTimeLineItem(
    ...
    relativePosition: com.pb.audia.memo.presentation.models.MemoRelativePosition,
    onPlayClick: () -> Unit,
    onPauseClick: () -> Unit,
    ...
    Row(
        ...
        Box(
            ...
            if (relativePosition != _root_ide_package_.com.pb.audia.memo.presentation.models.MemoRelativePosition.SINGLE_ENTRY) {
                VerticalDivider(
                    modifier = when (relativePosition) {
                        _root_ide_package_.com.pb.audia.memo.presentation.models.MemoRelativePosition.FIRST -> _root_ide_package_.com.pb.audia.memo.presentation.components.noVerticalLineAboveModifier
                        _root_ide_package_.com.pb.audia.memo.presentation.models.MemoRelativePosition.LAST -> _root_ide_package_.com.pb.audia.memo.presentation.components.noVerticalLineBelowModifier
                        _root_ide_package_.com.pb.audia.memo.presentation.models.MemoRelativePosition.IN_BETWEEN -> Modifier
                        else -> Modifier
                    }
                )
            }
...
private fun MemoTimeLineItemPreview() {
    AppTheme {
        _root_ide_package_.com.pb.audia.memo.presentation.components.MemoTimeLineItem(
            ...
            relativePosition = _root_ide_package_.com.pb.audia.memo.presentation.models.MemoRelativePosition.LAST,
            onPlayClick = {},
            onPauseClick = {},
